    ...
    <div className="space-y-4 ">
      ...
      >
        ...
        <Link
          ...
          className={`block text-center bg-sky-50 text-sky-600 border border-sky-500 hover:bg-sky-100 active:bg-sky-300 ${style}`}
          prefetch={false}
        >
          Edit
        </Link>
        <button
          className={`bg-red-50 border text-red-600 border-red-500 active:bg-red-300 hover:bg-red-100 ${style}`}
        >
          Delete
        </button>
      </form>
      <section className="drop-shadow-md bg-white p-6 rounded-lg min-h-[50vh]">
        <h2 className="text-3xl font-semibold text-[#252525] break-words">
          {memo.title}
        </h2>
        <hr className="my-4" />
        <article>
